...
declare var newLine: Function;

declare var variables: {[x: string]: string};
declare var commands: {[x: string]: Function};
declare var help: {[x: string]: string};

declare var echo: Function;

function main() {
    window.cl = document.getElementById("console") as HTMLDivElement;
    ...
    var _commands = {
        ...
        "javascript": (args: string[]): number => {return commands.js(args)},
